#ifndef FAN_H
#define FAN_H
////////////////////////5.31: edited comments and fixed format
#include <stdlib.h>
#include <stdio.h>
...
# define MAX_N 3000   /*max length of N*/
# define RAND_N 100        /*number of random spots,no bigger than MAX_N*/
...
static struct ndpi_detection_module_struct *ndpi_struct = NULL;  //detection module
static struct ndpi_flow *ndpi_flows_root = NULL;  //root of flow table

static struct ndpi_flow *acl_root = NULL;  //ACL root
...
float map[10] = {1, 1, 1, 1, 1, 0.01, 0.01, 0.01, 0.01, 0.01}; //randgen ration destribution
...
typedef struct _HASH_TABLE{
    NODE* phead;           //optional to simplify the defination
    NODE** chainhash;
}HASH_TABLE;
