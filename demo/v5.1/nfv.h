...
#define CPUS 1//should be change to 4!!!!!!!!!!!!!!!!!!!!!!!!!

#define PHYSICAL_CPUS 4//should be change to 40!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

#define CORES_PER_CPU 4//should be changed to 10!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#define P3_STARTING_CPU 2

#define P4_STARTING_CPU 2

#define P5_STARTING_CPU 2

#define P6_STARTING_CPU 2

#define P7_STARTING_CPU 2
/////////////////////////////////
#define SEND1_CPU 0

#define P8_STARTING_CPU 1

#define P9_STARTING_CPU 2

#define P10_STARTING_CPU 2

#define P11_STARTING_CPU 2

#define P12_STARTING_CPU 2

#define P13_STARTING_CPU 2

#define P14_STARTING_CPU 2

#define P15_STARTING_CPU 2
////////////////////////////////
#define SEND2_CPU 0

#define P16_STARTING_CPU 1

#define P17_STARTING_CPU 2

#define P18_STARTING_CPU 2

#define P19_STARTING_CPU 2

#define P20_STARTING_CPU 2

#define P21_STARTING_CPU 2

#define P22_STARTING_CPU 2

#define P23_STARTING_CPU 2
////////////////////////////////
#define SEND3_CPU 0

#define P24_STARTING_CPU 1

#define P25_STARTING_CPU 2

#define P26_STARTING_CPU 2

#define P27_STARTING_CPU 2

#define P28_STARTING_CPU 2

#define P29_STARTING_CPU 2

#define P30_STARTING_CPU 2

#define P31_STARTING_CPU 2
////////////////////////////////
#define SEND4_CPU 0

#define P32_STARTING_CPU 1

#define P33_STARTING_CPU 2

#define P34_STARTING_CPU 2

#define P35_STARTING_CPU 2

#define P36_STARTING_CPU 2

#define P37_STARTING_CPU 2

#define P38_STARTING_CPU 2

#define P39_STARTING_CPU 2



#define FIRST_WORKING_CPU 1

#define LAST_WORKING_CPU 2
...
int setcpu(int cpu_id) {//set the process to work on cpu 'cpu_id'.
	...
	#endif
	cpu_id = cpu_id + (cpu_id / CORES_PER_CPU) * CORES_PER_CPU;//CORES_PER_CPU = 10 or 4
	cpu_set_t mask;
	CPU_ZERO(&mask);
	CPU_SET(cpu_id, &mask);
	CPU_SET(cpu_id + CORES_PER_CPU, &mask);
	int check;
...
int getcpu() {//get the cpu where the process is working on.
	...
	int count = 0;
	for(i = 0;i < CPUS;i++) {
		for(j = 0;j < CORES_PER_CPU;j++) {
			test_cpu = CPU_ISSET(i * 2 * CORES_PER_CPU + j, &set);
			//printf("i = %d, test_cpu = %d \n", i, test_cpu);
			if(test_cpu != 0) {
				cpunow = i * CORES_PER_CPU + j;
				count++;
			}
		}
	}
	if(count == 1) {
		...
		printf("there are more than one CPUs being used!\n");
